/* Base Ori : AdiosBotz 
Script Ori : AdiosBotz 
Nama Base : AdiosBase
Nama Script : KuzaBase
Recode : Adios
Youtube Author : Adiosbotz
Youtube Recode : Adiosbotz
Nama Script Recode : Adios
...
let botname = '*_｢ AdiosBotz ｣ 冬_*' //NAMA BOT
let lolkey = '23ec48dd1daaba37f34c076f'
...
let symbol = '*☛*'
let faketeks = `*_｢ AdiosBase 2.5 ｣ 冬_*` 
...
const katalog = (teks) => {
res = kuza.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "AdiosBotz 😈", "thumbnail": fs.readFileSync('pee.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
